...
let game1 : game = {
    ...
    heroes = [ {id = FirstHero; name = "sjdksdfdksjfh"; user_id = Some("po33ddb8"); elo = Some(1200); position = (1, 2); life = 100; gold = 0; mines = 0; spawn_position = (1, 2); crashed = false}; {id = SecondHero; name = "random"; position = (8, 2); life = 100; gold = 0; mines = 0; spawn_position = (8, 2); crashed = false; user_id = None; elo = None}; {id = ThirdHero; name = "random"; position = (8, 7); life = 100; gold = 0; mines = 0; spawn_position = (8, 7); crashed = false; user_id = None; elo = None}; {id = FourthHero; name = "random"; position = (1, 7); life = 100; gold = 0; mines = 0; spawn_position = (1, 7); crashed = false; user_id = None; elo = None} ]
  }
